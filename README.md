...
This is the VB.NET version. A [C# version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_DotImageDemo_CS_x64.git) is also available.
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_DotImageDemo_VB_x64.git DotImageDemo --recursive
cd DotImageDemo
git submodule init
